      ...
      <ul style="list-style-type: none">
        ...
        >
          <div
            ...
            "
          >
            <b style="font-size: 25px">{{ station.fields.nom }}</b
            ><br />
            <i style="font-size: 15px"
              >{{ station.fields.adresse }} {{ station.fields.cp }}</i
            ><br />
            ...
            <b v-if="station.fields.ligne_tc" style="font-size: 17px"
              ><i
                >Lignes proche de la station: {{ station.fields.ligne_tc }}</i
              ></b
            >
          </div>
        </li>
